...
class TfLiteGpuDelegateOptionsV2 extends Struct {
  ...
  static Pointer<TfLiteGpuDelegateOptionsV2> allocate(bool isPrecisionLossAllowed, TfLiteGpuInferenceUsage inferencePreference, TfLiteGpuInferencePriority inferencePriority1, TfLiteGpuInferencePriority inferencePriority2, TfLiteGpuInferencePriority inferencePriority3, int experimentalFlagsBitmask, int maxDelegatePartitions) {
...
class TfLiteCoreMlDelegateOptions extends Struct {
  ...
  static Pointer<TfLiteCoreMlDelegateOptions> allocate(TfLiteCoreMlDelegateEnabledDevices enabledDevices, int coremlVersion, int maxDelegatedPartitions, int minNodesPerPartition) {
...
enum TfLiteType { none, float32, int32, uint8, int64, string, bool, int16, complex64, int8, float16 }
