...
class InterpreterOptions {
  ...
  factory InterpreterOptions() => InterpreterOptions._(tfLiteInterpreterOptionsCreate());
  ...
  set threads(int threads) => tfLiteInterpreterOptionsSetNumThreads(_options, threads);
